...
class RecipesTest < ActionDispatch::IntegrationTest
  ...
  test "should get recipes listing" do 
    ...
    assert_select "a[herf=?]",recipe_path(@recipe),text: @recipe.name
    assert_select "a[herf=?]",recipe_path(@recipe2),text: @recipe2.name


  end
  test "shoud get recipe show" do
  ...
  test "create new valid recipe" do
    ...
    description_of_recipe = "add chicken, add vegetable"
